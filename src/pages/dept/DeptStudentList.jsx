 ...
 * Displays a list of students in the department
 */
const DeptStudentList = () => {
    ...
    const handleRegister = async (e) => {
        ...
        try {
            ...
            setRegData({ first_name: '', last_name: '', email: '', student_id: '', password: '', role: 'STUDENT' })
            await loadStudents()
        } catch (err) {
    ...
    if (loading && students.length === 0 && !showRegister) return <LoadingState />
    ...
    return (
        <div className="page-container">
            ...
            <div className="info-card">
                <p>List of all students in your department.</p>
            </div>
